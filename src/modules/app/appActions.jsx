...
const appActions = {
  ...
  setConfirmContent: payload => actionCreator(appConstants.actions.SET_CONFIRM_CONTENT, payload),
  setExpense: payload => actionCreator(appConstants.actions.SET_EXPENSE, payload),
};
